...
function viewQuestions($id){ // Redirection vers le questionnarie avec l'id du candidat
	global $admin,$compact,$class_cat;
	return ($admin && !$compact)? "<tr><td class='td$class_cat'><span class='btn-view visualiser-questionnaire' title='Voir le questionnaire du candidat $id' onmousedown='redirAnswers($id)' onmouseup='window.location.reload()'></span></td>":"";
}
